...
\mainbar{
	\cvsection{EXPERIENCE}
		...
		\begin{itemize}
			\item Provide the Backend service in \technology{C++} to support GIFs in the ChromeOS Emoji Picker by calling the \technology{Tenor API}
		\end{itemize}
		...
		\begin{itemize}
			\item Wrote a \technology{Python} script that invokes a \technology{node.js} script to streamline the process of cross checking student information and their bank details using the \technology{pandas} library and the \technology{pdf-parse} node module
