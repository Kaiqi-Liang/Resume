...
\sidebar{
	...
	\cvsection{EDUCATION}
		...
		\wam{83.25}
		\begin{itemize}
			\item 2023: CSSC Vice President, ICPC
			\item 2022: CSSC Posgraduate Representative, UWA Student Guild International Student Department Liaison Committee
		\end{itemize}
	...
	\cvsection{SKILLS}
		...
		\begin{tabular}{llll}
			AWS & Git & Docker & PowerBI \\
			ROS & Unity & Unreal Engine & OpenGL
		\end{tabular}
}
